    ...
    public void add(final MServerInfo entry, final Runnable runnable) throws UnknownHostException {
        ...
        clientConnection.setPacketListener(new ClientQueryPacketListener() {
            ...
            public void onResponse(QueryResponseS2CPacket packet) {
                if (this.received) clientConnection.disconnect(new TranslatableText("multiplayer.status.unrequested"));
                    ...
                    if (serverMetadata.getFavicon() != null) {
                        ...
                        else MatHax.LOG.error(MatHax.LOG_PREFIX + "Invalid server icon (unknown format)");
                    }
            ...
            public void onDisconnected(Text reason) {
                if (!this.sentQuery) {
                    MatHax.LOG.error(MatHax.LOG_PREFIX + "Can't ping {}: {}", entry.address, reason.getString());
        ...
        try {
            ...
            MatHax.LOG.error(MatHax.LOG_PREFIX + "Couldn't send handshake", throwable);
        }
    }
