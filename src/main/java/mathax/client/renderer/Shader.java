...
public class Shader {
    ...
    public Shader(String vertPath, String fragPath) {
        ...
        if (vertError != null) {
            MatHax.LOG.error(MatHax.LOG_PREFIX + "Failed to compile vertex shader (" + vertPath + "): " + vertError);
        ...
        if (fragError != null) {
            MatHax.LOG.error(MatHax.LOG_PREFIX + "Failed to compile fragment shader (" + fragPath + "): " + fragError);
        ...
        if (programError != null) {
            MatHax.LOG.error(MatHax.LOG_PREFIX + "Failed to link program: " + programError);
