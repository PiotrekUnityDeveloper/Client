...
public class Systems {
    ...
    public static void save(File folder) {
        ...
        MatHax.LOG.info(MatHax.LOG_PREFIX + "Systems are saving...");

        for (System<?> system : systems.values()) system.save(folder);

        MatHax.LOG.info(MatHax.LOG_PREFIX + "Systems saved in {} milliseconds.", java.lang.System.currentTimeMillis() - start);
    }
    ...
    public static void load(File folder) {
        long start = java.lang.System.currentTimeMillis();
        MatHax.LOG.info(MatHax.LOG_PREFIX + "Systems are loading...");

        for (Runnable task : preLoadTasks) task.run();

        for (System<?> system : systems.values()) system.load(folder);

        MatHax.LOG.info(MatHax.LOG_PREFIX + "Systems loaded in {} milliseconds.", java.lang.System.currentTimeMillis() - start);
    }
